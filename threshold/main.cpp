...
int main(int argc, char* argv[])
{
    ...
    // Loads an image
    cv::samples::addSamplesDataSearchPath("/usr/local/Cellar/opencv/4.5.3_2/samples/data");	
    cv::Mat src = cv::imread(cv::samples::findFile(filename), cv::ImreadModes::IMREAD_GRAYSCALE);
    cv::Mat mSrc;
